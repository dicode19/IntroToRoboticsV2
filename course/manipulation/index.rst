Маніпуляція: огляд модуля 
=============================

У цьому модулі студенти:

* Розуміти основи маніпуляції та її застосування
* Дізнайтеся, як керувати роботом-маніпулятором XRP 

По завершенні цього модуля студенти зможуть:

* Напишіть коротку програму для керування рукою робота.
* Впровадити спеціальні функції для управління роботом-маніпулятором
* Маніпулюйте їхнім оточенням за допомогою роботизованої руки
