...
Експериментальна робототехнічна платформа (XRP)
====================================

Що таке платформа XRP?
-------------------------

XRP (Експериментальна робототехнічна платформа) [бета-версія], розроблена завдяки співпраці 
...
.. toctree:: 
   ...
   `Повідомити про проблеми з курсом `_
